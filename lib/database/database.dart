final List<Map<String, String>> main_categories = [
  {
    "title": "تحدي معلومات كرة القدم",
    "image": "assets/main/games/تحدي معلومات كرة القدم.png",
    "path": "/games",
    "type": "لعبة جماعية",
  },
  {
    "title": "دور ال16",
    "image": "assets/main/games/دور ال16.png",
    "path": "/round",
    "type": "لعبة جماعية",
  },
];
...
final List<Map<String, String>> game_categories = [
  ...
  {
    "title": "الجرس",
    "image": "assets/main/games/الجرس.png",
    "path": "/bell",
    "rules": "سؤال واللي يجاوب اسرع ياخد النقطة",
    "type": "لعبة فردية",
    "rounds": "10 جولات",
  },
  {
    "title": "المستحيل",
    "image": "assets/main/games/المستحيل.png",
    "path": "/impossible",
    "rules": "سؤال مستحيل واللي يجاوب اسرع ياخد 2 بوينت",
    "type": "لعبة فردية",
    "rounds": "5 جولات",
  },
  {
...
final List<Map<String, String>> challenge_categories = [
  {
    "title": "ماذا تعرف",
    "image": "assets/main/30 Challenge.png",
    "path": "/wdyk",
    "rules":
        "سؤال وكل فريق معاه 30 ثانية علشان يجاوب واللي اجابته اقرب بياخد نقطة ولو حد جاب اجابة صح بياخد نقطتين",
    "type": "لعبة فردية",
